...
class Proyecto_Admin extends Proyecto{
    ...
    public function __construct(string $nombre, string $empresa, int $fechainicio = 1, string $fechaInicio = "", string $fechaFin = "",  int $tipo,$exp) {
        parent::__construct($nombre, $empresa, $fechaInicio, $fechaFin, );
