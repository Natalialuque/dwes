            ...
            if ($linea != "") {
                ...
                foreach ($linea as $key => $value) {
                    ...
                    foreach ($prop as $key => $value) {
                        if($key == 0 && $value == "nombre") $nombre= $value;
                        if($key == 0 && $value == "empresa") $empresa= $value;
                        if($key == 0 && $value ==  "fecha1") $fecha1= $value;
                        if($key == 0 && $value ==  "fecha2") $fecha2= $value;
                        if($key ==0 && $value ==  "tipo") $tipo= $value;
                    }
                }
