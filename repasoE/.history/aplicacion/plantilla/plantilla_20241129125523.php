...
function inicioCuerpo($cabecera, array $barraLogica = [])
{
    ...
    $colorFondo = $_COOKIE["color_fondo"] ?? COLORESTEXTO["blanco"];
?>

    <body>
        <?php

        echo "<div id='documento' style = 'background-color:{$colorFondo};color:{$colorTexto};'>";
        ?>
        <header>
        ...
        ?><div id="barraLogin"><?php
                                        echo "Nombre de usuario: " . $acceso->getNombre() . " &emsp; <a href='/aplicacion/acceso/cerrar_sesion.php'>Cerrar Sesion</a>";
                                        ?></div><?php
                }
                    ?>
        <!-- <br> -->
        <div id="barraMenu">
            <ul>
                ...
                <li><a href="/aplicacion/personalizar/personalizar.php">Personalizar sitio web</a></li>
                <li><a href="/aplicacion/acceso/login.php">Login</a></li>
                <li><a href="/aplicacion/texto/verTextos.php">Ver Textos</a></li>
                <li><a href="/aplicacion/usuarios/Index.php">Index Usuarios</a></li>
            </ul>
        </div>
