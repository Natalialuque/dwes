<?php
    ...
    // Dejo comentado porque tengo un problema con la expresión regular
    // para añadir otras 
$nprop = 0;
$pro1->aniadeOtras("adicional1", "valor1", $nprop,  "importe1", "2","importe2", "3", );
// $pro2->aniadeOtras("adicional2", "valor1", $nprop, "importe3", "2", "importe4", "3", $nprop);
echo($pro1->getDescripcionOtras()
