            ...
            if ($linea != "") {
                ...
                foreach ($linea as $key => $value) {
                    ...
                    foreach ($prop as $key => $value) {
                        ...
                        if($key == "empresa") $empresa= $value;
                        if($key == "fecha1") $fecha1= $value;
                        if($key == "fecha2") $fecha2= $value;
                        if($key == "tipo") $nombre= $value;
                    }
                }

                $objeto = new Proyecto($linea[1], $linea[3], $linea[5], $linea[7], $linea[9]);
                //cargamos el objeto
