...
class CCaja extends CWidget
{
    ...
    public function dibujaApertura(): string
    {
        ...
        echo CHTML::botonHtml(CHTML::imagen("/imagenes/iconoOcultar.png", "", ["class" => "iconoOcultar"]), ["id" => $idBoton,  "onclick" => "ocultar('$idBoton','$idCaja')", "class" => "bOcultar"]);
        
        echo CHTML::dibujaEtiqueta("div", ["id" => $idCaja, "class" => "caja"], "", false) . PHP_EOL;
        echo CHTML::dibujaEtiqueta("h1",  [], $this->_titulo );
